      ...
      <q-header bordered class="bg-white text-black">
        ...
        <q-toolbar class="bg-white lt-md">
          ...
          <q-toolbar-title class="flex items-center justify-center">
            <router-link to="/">
              <img class="headerImage" alt="" src="./assets/tactus_logo.jpg" style="max-height: 50px;">
            </router-link>
          </q-toolbar-title>
        </q-toolbar>
        ...
        <q-toolbar class="bg-white q-pl-none gt-sm">
          <q-toolbar-title class="flex items-center justify-center gt-sm" style="max-width: 300px; height:50px; flex-grow: 100;">
            <router-link to="/" class="flex justify-center">
              <img class="headerImage" alt="" src="./assets/tactus_logo.jpg" style="max-height: 50px; width: 41.6%;">
            </router-link>
          </q-toolbar-title>
