	...
	<q-page>
		<div class="q-pa-md">
			<div class="col-xs-12 col-sm-11 col-md-10 col-lg-8 col-xl-7 row justify-center">
				<iframe width="560" height="315" src="https://www.youtube.com/embed/8jvSjqbPf8I" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
			</div>
			<div class="col-xs-12 col-sm-11 col-md-10 col-lg-8 col-xl-7 row justify-center">
...
export default {
  ...
  methods: {
	...
	playAudio2() {
		var audio = new Audio(require('../assets/PAASAS.mp3'));
		audio.play();
	},
	playAudio3() {
